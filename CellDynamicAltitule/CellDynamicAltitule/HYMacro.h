...
#define SCALE_HEIGHT(h) (SCREEN_HEIGHT/667.0*h)
...
/*基地址*/
#define URL_BASE @"http://10.30.8.3:9000/yonyou/"//根据项目进行修改

//#define URL_BASE @"http://101.200.91.40:8061/AndroidService/"//根据项目进行修改

#define BTL_LoginSingleton [LoginCallbackSingleton shareInstance]


#define RequestERR @"连接失败，请检查网络"
